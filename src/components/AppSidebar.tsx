...
import { LayoutDashboard, FilePlus, FileText, Settings, BarChart3, LogOut, ClipboardList, Receipt } from "lucide-react";
...
export function AppSidebar() {
  ...
  const adminItems = [
    ...
    { title: "General Claims", url: "/admin/general-claims", icon: Receipt },
